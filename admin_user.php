...
<div class="div_clear">
  ...
  <span style="font-weight:bold">您当前的位置：</span><span class="active1">[用户中心]-</span><a href="admin_book.php"><span>[书籍中心]</span></a>
  </div>
  ...
  <table cellspacing="0px" cellpadding="0px">
	...
	$db=new mydb();
	$sql="SELECT phone,department,email,school FROM user";
