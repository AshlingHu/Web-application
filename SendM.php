...
require_once dirname(__DIR__) . '/html/api_sdk/vendor/autoload.php';
...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIl8MdchOndkU6"; // AccessKeyId

        $accessKeySecret = "lLiwzu0JWyPMCyLgnNP2mjU4FHnus1"; // AccessKeySecret
    ...
    public static function sendSms($phone,$code) {
        ...
        $request->setSignName("二手书交易网");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_129748328");
